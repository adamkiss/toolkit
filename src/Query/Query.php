...
namespace Adamkiss\Toolkit\Query;
...
use Adamkiss\Toolkit\Image\QrCode;
use Adamkiss\Toolkit\Query\Runners\Runner;
...
class Query
{
	 ...
	 *
	 * @throws \Adamkiss\Toolkit\Exception\BadMethodCallException If an invalid method is accessed by the query
	 * @throws \Adamkiss\Toolkit\Exception\InvalidArgumentException If an invalid query runner is set in the config option
	 */
