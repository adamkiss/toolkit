...
class Field extends Component
{
	 ...
	 *
	 * @var \Adamkiss\Toolkit\Form\Fields|null
	 */
	 ...
	 * @param string $type
	 * @param array $attrs
	 * @param \Adamkiss\Toolkit\Form\Fields|null $formFields
	...
	public static function defaults(): array
	{
		return [
			...
			'computed' => [
				'after' => function () {
					/** @var \Adamkiss\Toolkit\Form\Field $this */
					if ($this->after !== null) {
	 ...
	 * Parent collection with all fields of the current form
	 *
	 * @return \Adamkiss\Toolkit\Form\Fields|null
	 */
