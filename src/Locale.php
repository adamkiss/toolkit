...
class Locale
{
	 ...
	 *
	 * @throws \Adamkiss\Toolkit\Exception\Exception If the locale cannot be determined
	 * @throws \Adamkiss\Toolkit\Exception\InvalidArgumentException If the provided locale category is invalid
	 */
