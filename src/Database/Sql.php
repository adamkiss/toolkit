...
namespace Adamkiss\Toolkit\Database;
...
abstract class Sql
{
	 ...
	 * @throws \Adamkiss\Toolkit\Exception\InvalidArgumentException if no column type is given or the column type is not supported.
	 */
	 ...
	 *
	 * @param array $columns Array of column definition arrays, see `Adamkiss\Toolkit\Database\Sql::createColumn()`
	 ...
	 *
	 * @throws \Adamkiss\Toolkit\Exception\InvalidArgumentException if an invalid join type is given
	 */
	 ...
	 * @throws \Adamkiss\Toolkit\Exception\InvalidArgumentException if an invalid identifier is given
	 */
	 ...
	 *
	 * @throws \Adamkiss\Toolkit\Exception\InvalidArgumentException if an invalid table name is given
	 */
	 ...
	 *
	 * @throws \Adamkiss\Toolkit\Exception\InvalidArgumentException If the column is invalid
	 */
