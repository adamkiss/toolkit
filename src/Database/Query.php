...
use Adamkiss\Toolkit\Pagination;
...
class Query
{
	 ...
	 * Constructor
	 *
	 * @param \Adamkiss\Toolkit\Database\Database $database Database object
	 ...
	 *
	 * @return $this
	 * @throws \Adamkiss\Toolkit\Exception\InvalidArgumentException if the table does not exist
	 */
	...
	public function page(int $page, int $limit): object
	{
		...
		$collection = $this
			...
			->iterator('Adamkiss\Toolkit\Collection')
			->all();
